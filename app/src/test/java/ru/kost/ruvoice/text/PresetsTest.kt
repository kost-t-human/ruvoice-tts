...
class PresetsTest {
    ...
    @Test fun abbreviations() {
        ...
        // окончание сокращения — в падеж: «кол-ва», «кол-ву», «кол-вом», «кол-ве»
        assertEquals("большое количество воды, без количества, к количеству, с количеством, в количестве",
            n("большое кол-во воды, без кол-ва, к кол-ву, с кол-вом, в кол-ве"))
