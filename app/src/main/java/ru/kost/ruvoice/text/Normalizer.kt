...
object Normalizer {
    ...
    private val nameOfPlaces = """(?:школ|завод|институт|университет|театр|библиотек|музе|парк|улиц|площад|фабрик|академи|больниц|клиник|стадион|фонд|преми|училищ|лице|гимнази|колледж|центр|дворц|дворец|проспект|кинотеатр|аэропорт|станци|общеж|дом|сквер|бульвар|набережн)\p{L}*\s+"""
