...
ORTHOEPY = [('гм', 'гмм'), ('хм', 'хмм'), ('тсс', 'тссс'), ('тезис*', 'тэзис*'), ('тенденци*', 'тэнд+энци*'), ('тестир*', 'тэстир*'), ('тестов*', 'тэстов*')] + \
    [(w, 'тэ' + w[2:]) for w in 'тест теста тесту тестом тесте тесты тестов тестам тестами тестах темп темпа темпу темпом темпе темпы темпов темпам темпами темпах'.split()]
